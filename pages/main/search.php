...
$sql_places = "SELECT * FROM places,place_types WHERE places.id_place_type=place_types.id_place_type AND (places.placeName LIKE '%$tukhoa%' OR places.address LIKE '%$tukhoa%') ORDER BY places.star DESC LIMIT $begin,12";
